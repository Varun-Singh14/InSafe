                    ...
                    >
                        <View>
                            <View
                                ...
                                <Image
                                    source={require('../../assets/images/avatar16.jpg')}
                                    style={{
                                        width: 36,
                                        height: 36,
                                        borderRadius: 50,
                            ...
                            >
                                ...
                                >
                                    <TouchableOpacity onPress={handleIconPress3}>
                                        <Icon
                                            name={isFilled3 ? 'favorite' : 'favorite-outline'} // Use your icon names here
                                            size={30}
                                            color={isFilled3 ? 'red' : colors.postIconDark} // Change colors as needed
                                        />
                                    </TouchableOpacity>
                                    <Icon name="chat-bubble-outline" size={30} color={colors.postIconDark} marginHorizontal={8} />
                                    <Icon name="send" size={30} color={colors.postIconDark} />
